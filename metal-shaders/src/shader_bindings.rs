...
impl metal_app::render_pipeline::Function for test_shade_phong_blinn_with_constant_material {
...
pub struct test_shade_phong_blinn_with_textured_material_binds<'c> {
    pub material: BindOne<'c, Material>,
}
impl FunctionBinds for test_shade_phong_blinn_with_textured_material_binds<'_> {
    #[inline]
    fn encode_binds<E: BindEncoder>(self, encoder: &RenderCommandEncoderRef) {
        E::encode_one(encoder, self.material, 0);
    }
}
...
impl metal_app::render_pipeline::Function for test_shade_phong_blinn_with_textured_material {
