...
mod test {
    ...
    fn test() {
        ...
        {
            let p: RenderPipeline<1, NoFunctionConstants, Vertex1, Fragment1, NoDepth, NoStencil> =
                RenderPipeline::new(
                    "Test",
                    &device,
                    &lib,
        ...
        {
            let p: RenderPipeline<2, NoFunctionConstants, Vertex1, Fragment1, NoDepth, NoStencil> =
                RenderPipeline::new(
                    "Test",
                    &device,
                    &lib,
