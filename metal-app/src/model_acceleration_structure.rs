...
impl ModelAccelerationStructure {
    ...
    pub fn from_files<P: AsRef<Path>>(
        ...
        debug_time("ModelAccelerationStructure::from_files", || {
            ...
            // ========================================
            let mut primitive_data_buffers = vec![];
            ...
            for (i, mut geometry) in geometries.into_iter().enumerate() {
                    ...
                    |_,
                     GeometryToEncode {
                        ...
                        draws.push(Draw {
                            ...
                            normal_byte_offset: normals_buffer_offset,
                        });
                    },
                );
                ...
                tri_as_descs.extend(draws.into_iter().map(|draw| {
                    ...
                    // `geometry_buffers.normals`.
                    {
                        ...
                        tri_as_desc.set_primitive_data_element_size(
                            primitive_data_buffer.element_size() as _,
                        );
                        tri_as_desc
                            .set_primitive_data_stride(primitive_data_buffer.element_size() as _);
                        primitive_data_buffers.push(primitive_data_buffer);
                    }
                    tri_as_desc
                }));
            }
            ...
            let mut prim_as_sizes =
                device.acceleration_structure_sizes_with_descriptor(&prim_as_desc);
